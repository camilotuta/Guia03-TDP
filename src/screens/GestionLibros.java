...
public class GestionLibros extends javax.swing.JFrame {
        public static int idLibroSeleccionado = -1;
        ...
        private void initComponents() {
                ...
                jPanel1.add(lbLibros, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 1320, -1));
                ...
                tTablaLibros.addMouseListener(new java.awt.event.MouseAdapter() {
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                tTablaLibrosMouseClicked(evt);
                        }
                });
                spTabla.setViewportView(tTablaLibros);

                jPanel1.add(spTabla, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 130, 840, 470));
                ...
                jPanel1.add(btnCrearLibro, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 630, -1, -1));
                ...
                jPanel1.add(btnEliminarLibro, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 630, -1, -1));
        ...
        private void tTablaLibrosMouseClicked(java.awt.event.MouseEvent evt) {
                idLibroSeleccionado = obtenerIdSeleccionadoTabla();
                desactivarBotonEliminarLibro();
        ...
        private void desactivarBotonCrearNuevoLibro() {
                boolean camposValidos = ObtenerIU.obtenerLongitudTextoCampo(tfTitulo) > 2
                                ...
                                && ObtenerIU.obtenerLongitudTextoCampo(tfEstado) > 5
                                && ObtenerIU.obtenerLongitudTextoCampo(tfNumeroCopias) > 0;
                btnCrearLibro.setEnabled(camposValidos);

        }

        private void desactivarBotonModificarLibro() {
                boolean filaSeleccionada = obtenerIdSeleccionadoTabla() != -1;
                btnModificarLibro.setEnabled(filaSeleccionada);

        }

        private void desactivarBotonEliminarLibro() {
                boolean filaSeleccionada = obtenerIdSeleccionadoTabla() != -1;
                btnEliminarLibro.setEnabled(filaSeleccionada);
        ...
        private void limpiarCampos() {
                ...
                CambiarIU.ponerTextoCampo(tfNumeroPaginas, "");
                CambiarIU.ponerTextoArea(taSinopsis, "");
                CambiarIU.ponerTextoCampo(tfEstado, "");
                CambiarIU.ponerTextoCampo(tfNumeroCopias, "");
        }

        private int obtenerIdSeleccionadoTabla() {
                int row = tTablaLibros.getSelectedRow();
                if (row != -1) {
                        return (int) (tTablaLibros.getValueAt(row, 0));
                }
                return -1;
        }
        ...
        private void llenarTablaLibros() {
                ...
                String[] columnNames = { "ID", "Título", "Autor", "Género", "Editorial", "Número Páginas", "Idioma",
                                "Estado", "Sinopsis", "Número Copias" };
                DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);

                ArrayList<ArrayList<Object>> listaLibros;
                try {
                        listaLibros = OperacionCRUD.seleccionar("select * from libros",
                                        new String[] { "id", "titulo", "autor", "genero", "editorial", "numero_paginas",
                                                        "idioma", "estado", "sinopsis", "numero_copias" });

                        for (ArrayList<Object> fila : listaLibros) {
                                Object[] filaArray = fila.toArray(new Object[0]);
                                tableModel.addRow(filaArray);
                        }
                        tTablaLibros.setModel(tableModel);
        ...
        private void registrarLibro() {
                try {
                        ...
                        OperacionCRUD.registrar(
                                        String.format("insert into libros(titulo,autor,editorial,estado,numero_paginas,numero_copias,sinopsis,genero,idioma) values ('%s','%s','%s','%s',%d,%d,'%s','%s','%s')",
                                                        titulo, autor, editorial, estado, numeroPaginas, numeroCopias,
                                                        sinopsis, genero, idioma));

                        String nombreLibroRegistrado = String.format("EL LIBRO %s HA SIDO REGISTRADO CON ÉXITO.",
